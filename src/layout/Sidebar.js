		...
		<section className="h-screen max-h-screen sidebar sidebar_bg pt-8 overflow-y-auto overflow-x-hidden mobiles:hidden">
			...
			<div className="mt-16">
				<ul className="pl-8 mt-10">
					<SidebarItem currentPath={currentLocation} Icon={AiFillHome} path="/dashboard" caption="Dashboard" />
					<SidebarItem currentPath={currentLocation} Icon={FaFolder} path="/employee" caption="Employees" />
					<SidebarItem currentPath={currentLocation} Icon={MdAnalytics} path="/withdrawals" caption="Withdrawals" />

					<div className="border-white border-b-2 w-10"></div>
					<SidebarItem currentPath={currentLocation} Icon={HiBriefcase} path="/payments" caption="Payments" />
					<div className="border-white border-b-2 w-10"></div>
					{/* <SidebarItem
            ...
            caption="Support"
          /> */}
					<SidebarItem currentPath={currentLocation} Icon={AiFillSetting} path="/settings" caption="Settings" />
				</ul>
			</div>
			{/* <div className="mt-8">
