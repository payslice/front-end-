...
export const ChooseUser = () => {
  ...
  return (
    <div className="flex flex-col h-full md:justify-center mobiles:w-full mobiles:mt-20 auth_container mx-auto">
      <div className="text-[21px] md:text-3xl font-bold uppercase mb-6">
        choose user
      </div>
      <p className="text-sm md:text-base">
        Creating a more productive workforce is just few steps away{" "}
        <br className="hidden md:block" /> Enter email address to continue
      </p>
      <div className="choose-user-wrapper mt-[49px]">
        ...
        >
          ...
          <div className="user-type mr-5 my-auto">
            <div
              className={`${
                selectedIndex === 1 && "text-blue-700"
              } font-bold text-sm md:text-base`}
            >
              Employers
            </div>
            <p className="mb-0 text-gray-400 text-xs md:text-base">
              Access to your dashboard
            </p>
          </div>
          <MdOutlineKeyboardArrowRight
            className={`my-auto mr-0 md:mr-5 text-blue-700 text-2xl ${
