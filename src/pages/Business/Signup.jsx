  ...
  return (
    <>
      <div className="mobiles:p-0 flex flex-col mobiles:block mobiles:mt-20 mobiles:h-0 h-full justify-center mobiles:w-full auth_container mx-auto">
        <h1 className="text-[21px] md:text-3xl font-bold uppercase pt-32">SIGN UP</h1>
        {error && (
          <ErrorMessage
            title="Error"
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
                <div className={`${!error && "mt-[46px]"}`}>
                        <InputField
                                ...
                                {...register("full_name", {
                                        required: true,
                                        validate: (value) => value || "Please enter a valid name",
                                })}
                                required
                        />
                        <InputField
                        ...
                        <InputField
                                ...
                                {...register("phone_number", {
                                        required: true,
                                        validate: (value) => value || "Please enter a valid email address",
                                })}
                                required
                        />
                        <PasswordInput
