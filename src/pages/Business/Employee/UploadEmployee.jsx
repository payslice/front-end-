		...
		<div>
			<div className="header">
				<div className="left-col">
					        ...
					        <h2 className="text-2xl font-semibold pb-4">Upload all staff</h2>
                                                <a className='underline text-[#1C6AF4] pt-2' href='#under'>Download sample</a>
                                        </div>
          ...
          />
				...
				<div className="my-8">
					<Button buttonText="Save Staff Details" loading={uploading} onClick={uploadProfileIcon} />
				</div>
			</div>
		</div>
	);
