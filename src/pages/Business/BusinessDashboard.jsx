                ...
                <div>
                    <div className='flex items-center justify-between mobiles:block '>
                        ...
                        <div className="flex justify-between w-full">
                                <h2 className='text-lg font-semibold capitalize mobiles:mb-6 mobiles:mt-3'>
                                Welcome to Payslice,{" "}
                                {`${user?.first_name} ${user?.last_name}`}
                                </h2>
                                <Button buttonText="Request for Money" onClick={() => history.push('/business/request_money')} />
