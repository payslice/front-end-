...
const Navbar = () => {
	...
	return (
		<nav ref={tdc} className="flex justify-end bg-white p-6 shadow items-center sticky mobiles:hidden">
			{/* <div>
        <input type="text" placeholder="Type in to search" className="" />
			...
			<div className="flex items-center bg-gray-100 px-6 py-2 rounded">
				...
				<div className="text-gray-400 my-auto">
					...
					<p className="font-light mb-0 capitalize">{userData.section} account</p>
				</div>
				<MdKeyboardArrowDown className="my-auto ml-3" onClick={() => setShow(true)} />
				{show && (
					<div
